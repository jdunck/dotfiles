...
excludes="--exclude \"${root_dir}\" --exclude /.Spotlight-V100 --exclude /.com.apple.NetBootX --exclude /Library/Updates --exclude /private/var/vm $HOME/Dropbox --exclude $HOME/votizen/Dropbox --exclude $HOME/causes/Dropbox"
